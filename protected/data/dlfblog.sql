...
CREATE TABLE IF NOT EXISTS `dlf_link` (
  ...
  `sitename` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT '网站名称',
  `logo` varchar(128) CHARACTER SET utf8 DEFAULT NULL COMMENT '站标地址',
  `siteurl` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '网站地址',
  `description` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '描述',
  `target` enum('_blank','_top','_self','_parent') CHARACTER SET utf8 DEFAULT '_blank' COMMENT '打开方式',
  `status` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dlf_post` (
  ...
  `content` text CHARACTER SET utf8 NOT NULL,
  `summary` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '摘要',
...
CREATE TABLE IF NOT EXISTS `dlf_tag` (
  ...
  `type` enum('tag','category') CHARACTER SET utf8 NOT NULL DEFAULT 'tag',
  `name` varchar(128) CHARACTER SET utf8 NOT NULL,
  `slug` tinytext CHARACTER SET utf8,
...
INSERT INTO `dlf_tag` (`id`, `pid`, `type`, `name`, `slug`, `frequency`) VALUES
(1, 0, 'tag', 'yii', NULL, 2),
(2, 0, 'tag', 'blog', NULL, 2),
(3, 0, 'tag', 'test', NULL, 2),
(4, 0, 'tag', 'much', NULL, 1),
(5, 0, 'tag', 'about', NULL, 2),
(6, 0, 'tag', 'UEditor', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `dlf_twitter` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dlf_user` (
  ...
  `nickname` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '昵称',
  `password` varchar(128) CHARACTER SET utf8 NOT NULL,
  `avatar` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT '头像',
